...
class Combo(Control, Clickable):
    ...
    def __init__(self, tk, items=(), **properties):
        ...
        super(Combo, self).__init__(tk, **properties)
    ...
    def add(self, key, value):
        ...
        self.tk.queue(Task("Combo update id %d items '%s'" %
    ...
    def clear(self):
        ...
        self.tk.queue(Task("Combo cleared id %d" % self.id,
         {'control':self.name, "id":self.id, "action":"update", 
          "update":{"clear":True}}))
